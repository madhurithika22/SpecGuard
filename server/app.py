...
"""
FastAPI application for the Spec Gaming Env Environment.

This module creates an HTTP server that exposes the SpecGamingEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m spec_gaming_env.server.app
    ...
    multiple workers:
        uvicorn spec_gaming_env.server.app:app --workers 4
    """
    import uvicorn
